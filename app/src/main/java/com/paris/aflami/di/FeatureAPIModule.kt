...
import com.paris.aflami.bottomNavBar.bottomNavBarUI.BottomNavBarAPIImpl
...
object FeatureAPIModule {
    @Provides
    @Singleton
    fun provideAppNavigator(): com.paris.aflami.bottomNavBar.bottomNavBarUI.navigation.Navigator =
        com.paris.aflami.bottomNavBar.bottomNavBarUI.navigation.NavigatorImpl(com.paris.aflami.bottomNavBar.bottomNavBarUI.navigation.Destinations.MainGraph)
