...
data class MovieDto(
    ...
    @SerialName("belongs_to_collection") val tvShowBelongsToCollectionDto: MovieBelongsToCollectionDto? = null,
    @SerialName("budget") val budget: Int? = null,
    @SerialName("genres") val tvShowGenreDto: List<MovieGenreDto>? = null,
