    ...
    Column(
        ...
        Box(
            modifier = modifier
                ...
                .then(if (imageUrl != null) Modifier.padding(8.dp) else Modifier)
        ...
        if (showHint) {
            ...
            CompositionLocalProvider(
                ...
                Row(
                    ...
                    AppIcon(
                        imageVector = ImageVector.vectorResource(if (imageUrl != null) R.drawable.ic_horisontal_star else R.drawable.ic_falling_star),
...
const val previewImage = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlN_2oDX1b4g_9t34rg7062DiG6Ymtvmq9hg&s"
@Composable
@PreviewLightDark
