...
val mediaList = listOf(
    MediaUiState(
        ...
        categories = listOf("Action", "Crime", "Drama"), // Action, Crime, Drama
    ...
    MediaUiState(
        ...
        type = MediaTypeUi.MOVIE,
        categories = listOf("Action", "Crime", "Drama"), // Action, Adventure, Fantasy
    ...
    MediaUiState(
        ...
        type = MediaTypeUi.MOVIE,
        categories = listOf("Action", "Crime", "Drama"), // Sci-Fi, Adventure
    ...
    MediaUiState(
        ...
        title = "Inception",
        type = MediaTypeUi.MOVIE,
        categories = listOf("Action", "Crime", "Drama"), // Action, Sci-Fi, Thriller
    ...
    MediaUiState(
        ...
        title = "Interstellar",
        type = MediaTypeUi.MOVIE,
        categories = listOf("Action", "Crime", "Drama"), // Adventure, Drama, Sci-Fi
